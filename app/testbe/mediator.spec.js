    ...
    it('should automatically start a new game', done => {
        ...
        display0.on('message', (event) => {
            ...
            switch (decoded.opcode) {
                ...
                // updated game state
                case 'UDT':
                    mediator.should.have.property('game').that.is.an('object');
                    mediator.should.have.property('server').that.is.an('object');
                    mediator.game.should.have.property('mediator', mediator);
                    done();
                    break;
